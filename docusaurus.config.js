...
const config = {
    ...
    organizationName: 'Apache LarkMidTable',
    projectName: 'Apache LarkMidTable',
    i18n: {
        defaultLocale: "en",
        locales: ["en", "zh-CN"],
        localeConfigs: {
    ...
    themeConfig: ({
        ...
        footer: {
            ...
            <div style="margin-top: 20px;background: #f4f8fa">
                ...
                <p style="color: #999999;font-weight:400;text-align:left">Apache LarkMidTable is an effort undergoing incubation at The Apache Software Foundation (ASF), sponsored by the Apache Incubator. Incubation is required of all newly accepted projects until a further review indicates that the infrastructure, communications, and decision making process have stabilized in a manner consistent with other successful ASF projects. While incubation status is not necessarily a reflection of the completeness or stability of the code, it does indicate that the project has yet to be fully endorsed by the ASF.</p>
                <div style="border-top: 1px solid #ccc;min-height: 60px;line-height: 20px;text-align: center;font-family: Avenir-Medium;font-size: 14px;color: #999;display: flex;align-items: center;"><span>Copyright © 2021-${new Date().getFullYear()} The Apache Software Foundation. Apache LarkMidTable, LarkMidTable, and its feather logo are trademarks of The Apache Software Foundation.</span></div>
