...
const config = {
    ...
    organizationName: 'GitHub LarkMidTable',
    projectName: 'GitHub LarkMidTable',
    i18n: {
        defaultLocale: "en",
        locales: ["en", "zh-CN"],
        localeConfigs: {
        ...
        [
            ...
            ({
                docs: {
                    ...
                    editUrl: 'https://github.com/apache/incubator-birdLark-website/edit/main/',
                },
                blog: {
                    showReadingTime: true,
                    // Please change this to your repo.
                    editUrl:
                        'https://github.com/apache/incubator-birdLark-website/edit/main/',
                },
                theme: {
            ...
            items: [
                ...
                },
                {
                    ...
                    items: [
                        ...
                        },
                        {
                            ...
                            to: "https://interestinglab.github.io/birdLark-docs/#/zh-cn/v1/"
                        }
                    ]
                },
                {
                    to: 'https://github.com/InterestingLab/birdLark/releases',
                    position: 'right',
                    label: 'Download'
                },
                {
                ...
                },
                {
                    ...
                    items: [
                        {
                            label: "Foundation",
                            to: "https://www.github.io/",
                        },
                        {
                            label: "License",
                            to: "https://www.github.io/licenses/",
                        },
                        {
                            label: "Events",
                            to: "https://www.github.io/events/current-event",
                        },
                        {
                            label: "Security",
                            to: "https://www.github.io/security/",
                        },
                        {
                            label: "Sponsorship",
                            to: "https://www.github.io/foundation/sponsorship.html",
                        },
                        {
                            label: "Thanks",
                            to: "https://www.github.io/foundation/thanks.html",
                        },
                    ],
                },

                {
                    href: 'https://github.com/apache/incubator-birdLark',
                    label: 'GitHub',
                    position: 'right',
                },
                {
            ...
            links: [
                {
                    ...
                    items: [
                        ...
                        {
                            label: 'Releases',
                            href: 'https://github.com/apache/incubator-birdLark/releases',
                        },
                    ],
                },
                {
                    ...
                    items: [
                        ...
                        {
                            label: 'Issue Tracker',
                            href: 'https://github.com/apache/incubator-birdLark/issues',
                        },
                        {
                            label: 'Pull Requests',
                            href: 'https://github.com/apache/incubator-birdLark/pulls',
                        },
                    ],
                },
                {
                    ...
                    items: [
                        ...
                        },
                        {
                            ...
                            href: 'mailto:dev-subscribe@birdLark.github.io',
                        },
                        {
                            label: 'Mail Archive',
                            href: 'https://lists.github.io/list.html?dev@birdLark.github.io',
                        },
                    ],
                },
        ...
        [
            '@docusaurus/plugin-content-docs',
            {
                ...
                editUrl: ({locale, versionDocsDirPath, docPath}) => {
                    if (locale !== 'en') {
                        return `https://github.com/apache/incubator-birdLark-website/edit/dev/i18n/${locale}/${docPath}`;
                    }
                    return `https://github.com/apache/incubator-birdLark-website/edit/dev/${versionDocsDirPath}/${docPath}`;
                },
                sidebarPath: require.resolve('./sidebars.js'),
            },
        ],
